...
//           0123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234
    ...
    void JuegoMesa::configuraJuego () {
        ...
        *******************************************************************************************/
        ...
        //
        AbejaReina      ->ponSitioFicha (Coord {24, 8});
        AbejaGuardia    ->ponSitioFicha (Coord {17, 15});
        AbejaExploradora->ponSitioFicha (Coord {30, 12});
        AbejaNodriza    ->ponSitioFicha (Coord {39, 15});
        AranaReina      ->ponSitioFicha (Coord {23, 35});
        Avispa          ->ponSitioFicha (Coord {19, 33});
        Polilla         ->ponSitioFicha (Coord {23, 31});
        MoscaCarronera      ->ponSitioFicha (Coord {35, 31});
        //
